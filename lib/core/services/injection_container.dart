...
Future<void> initDependencies() async {
  ...
  getIt.registerLazySingleton<CategoryDataSource>(() => LocalCategoryDataSource(getIt<CategoryDao>()));
  getIt.registerLazySingleton<ContactDataSource>(() => LocalContactDataSource(getIt<ContactDao>()));
  ...
  getIt.registerLazySingleton(() => GetAllCategoryUseCase(getIt<CategoryRepository>()));
  ...
  getIt.registerLazySingleton(() => EditCategoryUseCase(getIt<CategoryRepository>()));

  // Register Use Contact Cases
  getIt.registerLazySingleton(() => InsertContactUseCase(getIt<ContactRepository>()));
}
